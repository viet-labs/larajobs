...
@section('content')
    <div class="max-w-[95%] mx-auto mt-6">
        ...
        @endif
        <form method="POST" action="{{ url('update-work') }}">
            @csrf
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="tieu_de" name="tieu_de" type="text" required value="{{$workList->tieu_de}}"
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="hinh_thuc_lam_viec" name="hinh_thuc_lam_viec" type="text" required value="{{$workList->hinh_thuc_lam_viec}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="loai_cong_viec" name="loai_cong_viec" type="text" required value="{{$workList->loai_cong_viec}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="dia_chi_lam_viec" name="dia_chi_lam_viec" type="text" required value="{{$workList->dia_chi_lam_viec}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <textarea id="noi_dung" name="noi_dung" type="text" required value="{{$workList->noi_dung}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </textarea>
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="muc_luong_toi_thieu" name="muc_luong_toi_thieu" type="number" required value="{{$workList->muc_luong_toi_thieu}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="muc_luong_toi_da" name="muc_luong_toi_da" type="number" required value="{{$workList->muc_luong_toi_da}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                <label for="ngay_het_han" class="block text-sm font-medium leading-6 text-gray-900">Expiration
                    Date</label>
                <div class="mt-2">
                    <input id="ngay_het_han" name="ngay_het_han" type="date" required value="{{$workList->ngay_het_han}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="user_id" name="user_id" type="text" required value="{{$workList->user_id}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
            ...
            <div class="my-2">
                ...
                <div class="mt-2">
                    <input id="to_chuc_id" name="to_chuc_id" type="text" required value="{{$workList->to_chuc_id}}"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4">
                </div>
            </div>
